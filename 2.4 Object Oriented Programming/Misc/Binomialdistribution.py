...
class Binomial(Distribution):
    ...
    def pdf(self, k):
        ...
        comb_func = lambda n, x: math.factorial(n)/(math.factorial(x)*math.factorial(n-x))
        pdf_val = comb_func(self.n, k)*math.pow(self.p, k)*math.pow(1-self.p, self.n-k)
        return pdf_val
    ...
    def __repr__(self):
        ...
        return 'mean {:.0f}, standard deviation {:.1f}, p {:.1f}, n {:.0f}'.format(self.mean,
        self.stdev,
        self.p,
        self.n)
